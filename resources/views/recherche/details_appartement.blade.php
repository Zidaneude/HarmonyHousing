...
<body class="mt-5">
                    ...
                    <div class="embla__container">
                        ...
                        <div class="embla__slide slider-image item"
                            ...
                            <div class="slide-content">
                                <div class="item-wrapper">
                                    <div class="item-img">
                                        <img src="/storage/{{ $logements[0]->a_photos1 }}"
                                            alt="Mobirise Website Builder">
                                    </div>
                                </div>
                        ...
                        <div class="embla__slide slider-image item"
                            ...
                            <div class="slide-content">
                                <div class="item-wrapper">
                                    <div class="item-img">
                                        <img src="/storage/{{ $logements[0]->a_photos2 }}"
                                            alt="Mobirise Website Builder">
                                    </div>
                                </div>
    ...
    <section data-bs-version="5.1" class="features17 cid-tK1uerIJsL" id="features18-c">
        ...
        <div class="container">
            <div class="mbr-section-head">
                <div class="col-12">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-7"><strong>Equipements dulogement</strong></h4><br>
                </div>
            </div>
    ...
    <section data-bs-version="5.1" class="features14 cid-tK1sB26v3q" id="features15-8">
        ...
        <div class="container" style="box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.2);">
            ...
            <div class="row justify-content-center">
                ...
                @if ($appartement->equipements->contains('nom', 'Internet'))
                ...
                @if ($appartement->equipements->contains('nom', 'Chauffage'))
                    <div class="card col-12 col-md-6 col-lg-3">
                        <div class="card-wrapper">
                            <div class="form-check">
                ...
                @if ($appartement->equipements->contains('nom', 'Ordinateur'))
                    <div class="card col-12 col-md-6 col-lg-3">
                        <div class="card-wrapper">
                            <div class="form-check">
                ...
                @if ($appartement->equipements->contains('nom', 'Climatisation'))
                    <div class="card col-12 col-md-6 col-lg-3">
                        <div class="card-wrapper">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="check3" name="option3"
    ...
    <section data-bs-version="5.1" class="features14 cid-tK1sLIbu62" id="features15-a">
        ...
        <div class="container" style="box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.2);  margin-bottom: 5px;">
            <div class="row justify-content-center">
                @if ($appartement->equipements->contains('nom', 'Télévision'))
                    <div class="card col-12 col-md-6 col-lg-3">
                        <div class="card-wrapper">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="check1" name="option1"
                ...
                @if ($appartement->equipements->contains('nom', 'Cintres pour vêtements'))
                    <div class="card col-12 col-md-6 col-lg-3">
                        <div class="card-wrapper">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="check1" name="option1"
                ...
                @if ($appartement->equipements->contains('nom', 'Fer à repasser'))
                    <div class="card col-12 col-md-6 col-lg-3">
                        <div class="card-wrapper">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="check1" name="option1"
                ...
                @if ($appartement->equipements->contains('nom', "Équipements d'hygiène"))
                    <div class="card col-12 col-md-6 col-lg-3">
                        <div class="card-wrapper">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="check1" name="option1"
                    ...
                    <div class="mbr-section-btn align-center">
                        @if (isset($appartement))
                            <a class="btn btn-primary display-5"
                                href="{{ url('/payment/chambre/' . $appartement->id) }}"><span
