            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6">
                    <div class="item mbr-flex">
                        ...
                        <div class="icon-box">
                            <span class="mbr-iconfont mbrib-wifi"
                    ...
                    <div class="item mbr-flex">
                        ...
                        <div class="icon-box">
                            <span class="mbr-iconfont mbrib-desktop"
                                style="color: rgb(0, 0, 0); fill: rgb(0, 0, 0);"></span>
                        </div>
                        <div class="text-box">
                    ...
                    <div class="item mbr-flex">
                        ...
                        <div class="icon-box">
                            <span class="mbr-iconfont mobi-mbri-video-play mobi-mbri"
                                style="color: rgb(0, 0, 0); fill: rgb(0, 0, 0);"></span>
                        </div>
                        <div class="text-box">
                    ...
                    <div class="item mbr-flex">
                        ...
                        <div class="icon-box">
                            <span class="mbr-iconfont mobi-mbri-website-theme mobi-mbri"
                                style="color: rgb(0, 0, 0); fill: rgb(0, 0, 0);"></span>
                        </div>
                        <div class="text-box">
                ...
                <div class="col-12 col-lg-6">
                    <div class="item mbr-flex">
                        ...
                        <div class="icon-box">
                            <span class="mbr-iconfont socicon-curse socicon"
                                style="color: rgb(0, 0, 0); fill: rgb(0, 0, 0);"></span>
                        </div>
                        <div class="text-box">
                    ...
                    <div class="item mbr-flex">
                        ...
                        <div class="icon-box">
                            <span class="mbr-iconfont mbrib-protect"
                                style="color: rgb(0, 0, 0); fill: rgb(0, 0, 0);"></span>
                        </div>
                        <div class="text-box">
